                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td className="text-right">
                                                            <a href="#" data-toggle="modal" data-target="#edit_tax" className="btn btn-sm btn-white text-success mr-2"><i className="far fa-edit mr-1"></i> Edit</a> 
                                                            <a href="#" data-toggle="modal" data-target="#delete_tax" className="btn btn-sm btn-white text-danger mr-2"><i className="far fa-trash-alt mr-1"></i>Delete</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>GST</td>
