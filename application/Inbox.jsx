											...
											<div className="col top-action-left">
												<div className="float-left">
													<div className="btn-group dropdown-action">
														<button type="button" className="btn btn-white dropdown-toggle" data-toggle="dropdown">Select <i className="fas fa-angle-down"></i></button>
													...
													<div className="btn-group dropdown-action">
														<button type="button" className="btn btn-white dropdown-toggle" data-toggle="dropdown">Actions <i className="fas fa-angle-down"></i></button>
														<div className="dropdown-menu">
													...
													<div className="btn-group dropdown-action">
														<button type="button" className="btn btn-white dropdown-toggle" data-toggle="dropdown"><i className="fas fa-folder"></i> <i className="fas fa-angle-down"></i></button>
													...
													<div className="btn-group dropdown-action">
														<button type="button" data-toggle="dropdown" className="btn btn-white dropdown-toggle"><i className="fas fa-tags"></i> <i className="fas fa-angle-down"></i></button>
														<div role="menu" className="dropdown-menu">
