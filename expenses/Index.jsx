                                                ...
                                                {expenses.map((item, index) => {
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td className="text-right">
                                                            <Link to="/edit-expenses" className="btn btn-sm btn-white text-success mr-2"><i className="far fa-edit mr-1"></i> Edit</Link> 
                                                            <a href="#" className="btn btn-sm btn-white text-danger"><i className="far fa-trash-alt mr-1"></i>Delete</a>
                                                        </td>
                                                    </tr>
                                                    );  })}
                                                </tbody>
