                            ...
                            <div className="col-lg-10">
                               ...
                               {/*  /Page Header  */}
                                        ...
                                        <div className="cover-content">
                                            <div className="custom-file-btn">
                                                ...
                                                <label className="custom-file-btn-label btn btn-sm btn-white" htmlFor="cover_upload">
                                                    ...
                                                    <span className="d-none d-sm-inline-block ml-1">Update Cover</span>
                                                </label>
                                            </div>
                                        </div>
                                        {/*  /Custom File Cover  */}
                                ...
                                <div className="text-center mb-5">
                                    ...
                                    <h2>Charles Hafner <i className="fas fa-certificate text-primary small" data-toggle="tooltip" data-placement="top" title="" data-original-title="Verified"></i></h2>
